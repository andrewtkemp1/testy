<template>
  <v-container fluid>
    <v-row :align="alignment" :justify="justify">
      <v-col cols="6" :align="alignment" :justify="justify">
        <v-text-field
    ...
    <v-row v-if="!loadingCities" :align="alignment" :justify="justify">
      <v-expansion-panels>
        <v-expansion-panel
            ...
            <v-row :align="alignment" :justify="justify">
              ...
              >
                <v-card class="ma-3 pa-6">
                  <h4>{{ momentWeekday(weatherData.applicable_date) }} {{ momentDate(weatherData.applicable_date) }}</h4>
                  <img
                    :src="
